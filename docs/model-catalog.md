...
Instruct, Gemma 3 1B Instruct, Llama 3.2 1B Instruct, IBM Granite 3.3 2B
Instruct, and Mistral Nemo 12B Instruct. Qwen and Granite are sourced from their
publishers' official GGUF repositories, Phi, Llama, and Mistral from Bartowski
quantizations of the publishers' checkpoints, and Gemma from the llama.cpp
organization's GGUF repository. Curated downloads pin an immutable upstream
